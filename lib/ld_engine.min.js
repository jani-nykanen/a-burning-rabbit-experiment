...
this.graphics)};Core.prototype.update=function(a){a/=1/60;null!=this.activeScene&&null!=this.activeScene.update&&this.activeScene.update(this.evMan,a);null!=this.globalScene&&null!=this.globalScene.update&&this.globalScene.update(this.evMan,a);this.vpad.update();this.input.update();this.tr.update(a)};
...
AnimatedSprite.prototype.drawFrame=function(a,b,c,d,e,f,g){a.drawBitmapRegion(b,this.width*c,this.height*d,this.width,this.height,e,f,g)};AnimatedSprite.prototype.draw=function(a,b,c,d,e){this.drawFrame(a,b,this.frame,this.row,c,d,e)};AnimatedSprite.prototype.drawScaled=function(a,b,c,d,e,f,g){a.drawScaledBitmapRegion(b,this.width*this.frame,this.height*this.row,this.width,this.height,c,d,e,f,g)};var negMod=function(a,b){return 0>a?b- -a%b:a%b},Tilemap=function(a){a=(new DOMParser).parseFromString(a,"text/xml").getElementsByTagName("map")[0];this.width=String(a.getAttribute("width"));this.height=String(a.getAttribute("height"));a=a.getElementsByTagName("layer");this.layers=[];for(var b=0;b<a.length;++b){var c=a[b].getElementsByTagName("data")[0].childNodes[0].nodeValue.replace(/(\r\n|\n|\r)/gm,"").split(",");this.layers.push([]);for(var d=0;d<c.length;++d)this.layers[b][d]=parseInt(c[d])}};
Tilemap.prototype.getTile=function(a,b,c,d){b|=0;c|=0;d&&(b=negMod(b,this.width),c=negMod(c,this.height));return 0>b||0>c||b>=this.width||c>=this.height?-1:this.layers[a][c*this.width+b]};Tilemap.prototype.setTile=function(a,b,c,d){c|=0;d|=0;0>c||0>d||c>=this.width||d>=this.height||(this.layers[b][d*this.width+c]=a)};var INITIAL_TRANSITION_TIME=60,Fade={In:0,Out:1},Effect={Fading:0,HBars:1,VBars:2,Bars:3},Transition=function(){this.timer=0;this.speed=1;this.color={r:0,g:0,b:0};this.active=!1;this.effect=0;this.division=-1;this.cb=null};Transition.prototype.activate=function(a,b,c,d,e,f){this.mode=a;this.speed=b;this.cb=c;this.active=!0;this.timer=INITIAL_TRANSITION_TIME;this.division=null==e?-1:e;this.effect=null==f?Effect.Fading:f;null!=d?this.color=d:(this.color.r=0,this.color.g=0,this.color.b=0)};
Transition.prototype.update=function(a){this.active&&(this.timer-=this.speed*a,0>=this.timer&&(this.mode==Fade.In?(null!=this.cb&&this.cb(),this.mode=Fade.Out,this.timer+=INITIAL_TRANSITION_TIME):this.active=!1))};
Transition.prototype.draw=function(a){if(this.active){var b=a.canvas.width,c=a.canvas.height,d=this.timer/INITIAL_TRANSITION_TIME;this.mode==Fade.In&&(d=1-d);0<this.division&&(d=(d*this.division|0)/this.division);this.color.a=1;var e=d*a.canvas.height/2|0,f=d*a.canvas.width/2|0;switch(this.effect){case Effect.Fading:this.color.a=d;a.fillRect(0,0,b,c,this.color);break;case Effect.VBars:a.fillRect(0,0,a.canvas.width,e,this.color);a.fillRect(0,a.canvas.height-e,a.canvas.width,e,this.color);break;case Effect.HBars:a.fillRect(0,
0,f,a.canvas.height,this.color);a.fillRect(a.canvas.width-f,0,f,a.canvas.height,this.color);break;case Effect.Bars:a.fillRect(0,0,a.canvas.width,e,this.color),a.fillRect(0,a.canvas.height-e,a.canvas.width,e,this.color),a.fillRect(0,0,f,a.canvas.height,this.color),a.fillRect(a.canvas.width-f,0,f,a.canvas.height,this.color)}}};var Vec2=function(a,b){this.x=null!=a?a:0;this.y=null!=b?b:0};Vec2.prototype.addVec2=function(a){return new Vec2(this.x+a.x,this.y+a.y)};Vec2.prototype.add=function(a,b){return new Vec2(this.x+a,this.y+b)};Vec2.prototype.copy=function(){return new Vec2(this.x,this.y)};
